...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "api",
      testMatch: /(?:fr\d+-?(?:fr\d+)?|admin-auth|auth-e2e|citizen-lga-e2e|lga-portal-auth-e2e|investor-lga-e2e|chairman-crud-e2e|public-content-e2e|admin-surface-e2e|admin-lga-ward-e2e|payments-e2e|landing-reframe)\.spec\.ts$/,
      use: {},
    },
